...
class CatalogFiltersWidget extends StatefulWidget {
  final CatalogFilters availableFilters;
  ...
  @override
  State<CatalogFiltersWidget> createState() => _CatalogFiltersWidgetState();
}

class _CatalogFiltersWidgetState extends State<CatalogFiltersWidget> {
  late CatalogFilters _pendingFilters;
  ...
  @override
  void didUpdateWidget(CatalogFiltersWidget oldWidget) {
        ...
        Row(
          ...
          children: [
            TextButton(
              onPressed: () {
                setState(() {
                  _pendingFilters = CatalogFilters.empty();
                });
              },
